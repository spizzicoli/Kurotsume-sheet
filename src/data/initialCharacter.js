...
const initialCharacter = {
  ...
  skills: [
    ...
    { id: 'atletica', nome: 'Atletica', abilita: 'for', competenza: false },
    ...
    { id: 'persuasione', nome: 'Persuasione', abilita: 'car', competenza: false },
    ...
    { id: 'storia', nome: 'Storia', abilita: 'int', competenza: false }
  ],
  ...
  featureGroups: {
    ...
    razziali: [
      ...
      },
      {
        id: id('feat'),
        nome: 'Lingue',
        descrizione: 'Comune, Elfico, Infernale',
        usiMax: 0,
        usiSpesi: 0
      }
    ]
